...
import (
	...
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/bilibili_parse" 
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "天衍星", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "天衍星"),
